...
//        Mesh[] houseMesh = StaticMeshesLoader.load("src/images/house/house.obj", "images/house");
        GameItem house = new GameItem(houseMesh);

        Mesh[] terrainMesh = StaticMeshesLoader.load("models/terrain/terrain.obj", "models/terrain");
//        Mesh[] terrainMesh = StaticMeshesLoader.load("src/images/terrain/terrain.obj", "images/terrain");
        ...
        SkyBox skyBox = new SkyBox("src/images/skybox.obj", new Vector4f(0.65f, 0.65f, 0.65f, 1.0f));
