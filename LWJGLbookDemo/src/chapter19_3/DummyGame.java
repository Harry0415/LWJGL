...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Mesh quadMesh = OBJLoader.loadMesh("/images/plane.obj");
        ...
        // Setup  GameItems
        MD5Model md5Meshodel = MD5Model.parse("/images/monster.md5mesh");
        MD5AnimModel md5AnimModel = MD5AnimModel.parse("/images/monster.md5anim");
//        MD5Model md5Meshodel = MD5Model.parse("/images/boblamp.md5mesh");
//        MD5AnimModel md5AnimModel = MD5AnimModel.parse("/images/boblamp.md5anim");
