...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        float maxY = 0.1f;
        int textInc = 40;
        Terrain terrain = new Terrain(terrainSize, terrainScale, minY, maxY, "src/images/heightmap.png", "src/images/terrain.png", textInc);
        scene.setGameItems(terrain.getGameItems());

        // Setup  SkyBox
        SkyBox skyBox = new SkyBox("/images/skybox.obj", "src/images/skybox.png");
