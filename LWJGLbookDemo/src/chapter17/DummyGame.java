...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Texture normalMap = new Texture("src/images/rock_normals.png");

        Mesh quadMesh1 = OBJLoader.loadMesh("/images/quad.obj");
        Texture texture = new Texture("src/images/rock.png");
        ...
        Mesh quadMesh2 = OBJLoader.loadMesh("/images/quad.obj");
