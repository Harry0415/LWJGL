...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            buf = stbi_load("src/images/heightmap.png", w, h, channels, 4);
            if (buf == null) {
        ...
        Mesh mesh = OBJLoader.loadMesh("/images/cube.obj", instances);
        Texture texture = new Texture("src/images/terrain_textures.png", 2, 1);
        ...
        float range = 0.2f;
        float scale = 1.0f;
        Mesh partMesh = OBJLoader.loadMesh("/images/particle.obj", maxParticles);
        Texture particleTexture = new Texture("src/images/particle_anim.png", 4, 4);
        ...
        // Setup  SkyBox
        SkyBox skyBox = new SkyBox("/images/skybox.obj", new Vector4f(0.65f, 0.65f, 0.65f, 10.f));
