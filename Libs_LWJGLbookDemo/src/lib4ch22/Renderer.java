...
import lib4ch22.SpotLight;
import lib4ch22.PointLight;
import lib4ch22.DirectionalLight;
...
import lib4ch22.IHud;
import lib4ch22.Scene;
import lib4ch22.SceneLight;
import lib4ch22.SkyBox;
import lib4ch22.Utils;
import lib4ch22.Window;
import lib4ch22.AnimGameItem;
import lib4ch22.AnimatedFrame;
import lib4ch22.IParticleEmitter;
...
public class Renderer {
    ...
    private void setupParticlesShader() throws Exception {
        ...
        particlesShaderProgram.createVertexShader(Utils.loadResource("/lib4ch22/particles_vertex.vs"));
        particlesShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch22/particles_fragment.fs"));
    ...
    private void setupDepthShader() throws Exception {
        ...
        depthShaderProgram.createVertexShader(Utils.loadResource("/lib4ch22/depth_vertex.vs"));
        depthShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch22/depth_fragment.fs"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/lib4ch22/sb_vertex.vs"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch22/sb_fragment.fs"));
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("/lib4ch22/scene_vertex.vs"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch22/scene_fragment.fs"));
    ...
    private void setupHudShader() throws Exception {
        ...
        hudShaderProgram.createVertexShader(Utils.loadResource("/lib4ch22/hud_vertex.vs"));
        hudShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch22/hud_fragment.fs"));
