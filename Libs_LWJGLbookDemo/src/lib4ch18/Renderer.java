...
import lib4ch18.SpotLight;
import lib4ch18.PointLight;
import lib4ch18.DirectionalLight;
...
import lib4ch18.IHud;
import lib4ch18.Scene;
import lib4ch18.SceneLight;
import lib4ch18.SkyBox;
import lib4ch18.Utils;
import lib4ch18.Window;
...
public class Renderer {
    ...
    private void setupDepthShader() throws Exception {
        ...
        depthShaderProgram.createVertexShader(Utils.loadResource("/lib4ch18/depth_vertex.vs"));
        depthShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch18/depth_fragment.fs"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/lib4ch18/sb_vertex.vs"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch18/sb_fragment.fs"));
    ...
    private void setupSceneShader() throws Exception {
        ...
        sceneShaderProgram.createVertexShader(Utils.loadResource("/lib4ch18/scene_vertex.vs"));
        sceneShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch18/scene_fragment.fs"));
    ...
    private void setupHudShader() throws Exception {
        ...
        hudShaderProgram.createVertexShader(Utils.loadResource("/lib4ch18/hud_vertex.vs"));
        hudShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch18/hud_fragment.fs"));
