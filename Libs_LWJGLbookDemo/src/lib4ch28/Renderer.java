...
import lib4ch28.PointLight;
import lib4ch28.DirectionalLight;
...
import lib4ch28.Scene;
import lib4ch28.SceneLight;
import lib4ch28.SkyBox;
import lib4ch28.Utils;
import lib4ch28.Window;
import lib4ch28.AnimGameItem;
import lib4ch28.AnimatedFrame;
import lib4ch28.IParticleEmitter;
import lib4ch28.ShadowCascade;
import lib4ch28.ShadowRenderer;
import lib4ch28.StaticMeshesLoader;
...
public class Renderer {
    ...
    public void init(Window window) throws Exception {
        ...
        bufferPassMesh = StaticMeshesLoader.load("src/images/buffer_pass_mess.obj", "models")[0];
    }
    ...
    private void setupParticlesShader() throws Exception {
        ...
        particlesShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/particles_vertex.vs"));
        particlesShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/particles_fragment.fs"));
    ...
    private void setupSkyBoxShader() throws Exception {
        ...
        skyBoxShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/sb_vertex.vs"));
        skyBoxShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/sb_fragment.fs"));
    ...
    private void setupGeometryShader() throws Exception {
        ...
        gBufferShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/gbuffer_vertex.vs"));
        gBufferShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/gbuffer_fragment.fs"));
    ...
    private void setupDirLightShader() throws Exception {
        ...
        dirLightShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/light_vertex.vs"));
        dirLightShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/dir_light_fragment.fs"));
    ...
    private void setupPointLightShader() throws Exception {
        ...
        pointLightShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/light_vertex.vs"));
        pointLightShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/point_light_fragment.fs"));
    ...
    private void setupFogShader() throws Exception {
        ...
        fogShaderProgram.createVertexShader(Utils.loadResource("/lib4ch28/light_vertex.vs"));
        fogShaderProgram.createFragmentShader(Utils.loadResource("/lib4ch28/fog_fragment.fs"));
