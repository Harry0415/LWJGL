...
public class Prog6_1_sphere_Animation extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	public Prog6_1_sphere_Animation()
...
//		mMat.translate(sphLocX, sphLocY, sphLocZ);
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		// Camera angel
		cameraX = 0.0f; cameraY = 0.0f; cameraZ = 10f;
	...
	public static void main(String[] args) { new Prog6_1_sphere_Animation(); }
