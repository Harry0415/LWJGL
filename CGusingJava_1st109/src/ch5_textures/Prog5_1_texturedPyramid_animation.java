...
import org.joml.*;
import opengl.lib.Utils;
public class Prog5_1_texturedPyramid_animation extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	public Prog5_1_texturedPyramid_animation()
	...
	{	
		...
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog5_1.glsl", "code/fragShader4Prog5_1.glsl");
		setupVertices();
		
		cameraX = 0.0f; cameraY = 0.0f; cameraZ = 10.0f;
		pyrLocX = 0.0f; pyrLocY = 0.0f; pyrLocZ = 0.0f;

		brickTexture = Utils.loadTexture("images/gura.jpg");
	}
	...
	public static void main(String[] args) { new Prog5_1_texturedPyramid_animation(); }
