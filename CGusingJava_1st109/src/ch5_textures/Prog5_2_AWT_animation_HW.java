...
public class Prog5_2_AWT_animation_HW extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	public Prog5_2_AWT_animation_HW()
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		...
		float vertices[]=//new
			 {
				0.0f, 0.0f, 10f, 0.0f, 5f, 10f,
			    0.0f, 0.0f, 10f, 0.0f, 5f, 10f,
			    0.0f, 0.0f, 10f, 0.0f, 5f, 10f,
				0.0f, 0.0f, 10f, 0.0f, 5f, 10f,
				0.0f, 0.0f, 10f, 10f, 0.0f, 10f,
				10f, 10f, 0.0f, 0.0f, 10f, 0.0f
			 };
		//--------------------2020/11/19 Homework
		...
		//--------------------2020/11/19 Homework
		gl.glBindBuffer(GL_ARRAY_BUFFER, vbo[1]);//new
		FloatBuffer yertBuffer = Buffers.newDirectFloatBuffer(vertices);
		gl.glBufferData(GL_ARRAY_BUFFER, yertBuffer.limit()*4, yertBuffer, GL_STATIC_DRAW);
		//--------------------2020/11/19 Homework}
	}
	public static void main(String[] args) { new Prog5_2_AWT_animation_HW(); }
