...
public class Prog4_1_1_plainRedCube extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	{	GL4 gl = (GL4) drawable.getGL();
		...
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog4_1_1.glsl", "code/fragShader4Prog4_1_1.glsl");
		setupVertices();
...
//		cubeLocX = 0.0f; cubeLocY = -2.0f; cubeLocZ = 0.0f;
	...
	public static void main(String[] args) { new Prog4_1_1_plainRedCube(); }
