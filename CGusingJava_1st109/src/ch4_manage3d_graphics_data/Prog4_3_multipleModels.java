...
public class Prog4_3_multipleModels extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog4_3.glsl", "code/fragShader4Prog4_3.glsl");
		setupVertices();
	...
	public static void main(String[] args) { new Prog4_3_multipleModels(); }
