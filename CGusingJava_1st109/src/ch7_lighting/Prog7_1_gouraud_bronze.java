...
public class Prog7_1_gouraud_bronze extends JFrame implements GLEventListener
...
//	float matShi = Utils.goldShininess();
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog7_1.glsl", "code/fragShader4Prog7_1.glsl");
	...
	public static void main(String[] args) { new Prog7_1_gouraud_bronze(); }
