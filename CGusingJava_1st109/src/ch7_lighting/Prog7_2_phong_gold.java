...
public class Prog7_2_phong_gold extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog7_2.glsl", "code/fragShader4Prog7_2.glsl");
	...
	public static void main(String[] args) { new Prog7_2_phong_gold(); }
