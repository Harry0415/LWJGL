...
public class Prog9_3_environmentMapping extends JFrame implements GLEventListener
{	private GLCanvas myCanvas;
	...
	public Prog9_3_environmentMapping()
...
//		amt = 30.0f;
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog9_3.glsl", "code/fragShader4Prog9_3.glsl");
		renderingProgramCubeMap = Utils.createShaderProgram("code/vertCShader4Prog9_3.glsl", "code/fragCShader4Prog9_3.glsl");
		...
		skyboxTexture = Utils.loadCubeMap("images/cubeMapFor9_3");
	...
	public static void main(String[] args) { new Prog9_3_environmentMapping(); }
