...
public class Prog9_2_skyboxOpenGL extends JFrame implements GLEventListener
...
//		mMat.rotateX((float)Math.toRadians(35.0f));
	...
	{	GL4 gl = (GL4) GLContext.getCurrentGL();
		renderingProgram = Utils.createShaderProgram("code/vertShader4Prog9_2.glsl", "code/fragShader4Prog9_2.glsl");
		renderingProgramCubeMap = Utils.createShaderProgram("code/vertCShader4Prog9_2.glsl", "code/fragCShader4Prog9_2.glsl");
		...
		skyboxTexture = Utils.loadCubeMap("images/cubeMapFor9_2");
	...
	public static void main(String[] args) { new Prog9_2_skyboxOpenGL(); }
