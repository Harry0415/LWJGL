...
{	float shadowFactor=0.0;
	...
	/*
	*
	*	Below section, if un-commented, produces a 64-sample hi resolution soft shadow.
	*
	*/
	/*
	//float swidth = 2.5; //Origin
	float swidth = 5.5;
	...
	*/
	...
	shadowFactor = shadowFactor / 81.0;
